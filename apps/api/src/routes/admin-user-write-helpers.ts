...
import { isFixedAdminLogin, parseUpdateUserInput } from "./admin-user-input-helpers";
import type { UserRow, UserWriteResult, ValidatedCreateUserInput } from "./admin-user-types";
...
export const createUserRecord = async (
  ...
  params: ValidatedCreateUserInput
